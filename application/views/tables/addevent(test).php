            	...
            	<div class="">
			         ...
			         <div class="col-lg-8 col-md-offset-1">
				        <form action="" mathod="post" role="form">
				        	<div class="row">
				        		<label for=""></label>
				        		<input type="text" class="input-sm form-control" name="eventname" placeholder="Название мероприятия">
				        	</div> 	
				        	<div class="row">
				        		<label for=""></label>
				        		<input type="text" class="input-sm form-control" name="city" placeholder="Город проведения">
				        	</div> 	
				        	<div class="row">
				        		<label for=""></label>
				        	...
				        	<div class="row">
				        		<label for=""></label>
				        		<input type="text" class="input-sm form-control" name="start_data" placeholder="Дата проведения">
				        	</div>
				        	<div class="row">
				        	...
				        	<div class="row">
				        		<label for=""></label>
				        		<input type="text" class="input-sm form-control" name="website" placeholder="Сайт мероприятия">
				        	</div>
				        	<br>
				        	<div class="row">
				        		<label for="">На начало мероприятия существует ли рейтинг?</label>
				        		<input type="radio" name="start" value="1">Да</radio>
				        		<input type="radio" name="start" value="2">Нет</radio>
				        	</div>
				        </form>
			         </div>
    			</div>
